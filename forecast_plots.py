...
Description: A tool for visualizing forecasted versus historical values of a target series. 
It is designed to support comparative analysis of forecasting performance across different 
forecast horizons and to report key accuracy metrics.
"""
