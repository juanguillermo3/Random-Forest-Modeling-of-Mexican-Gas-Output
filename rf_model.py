"""
Title: RF Model
Description: A set of utilities to support the training and evaluation of Random Forest models, 
with specific adaptations for forecasting applications. 
The functions `train_random_forest` and `evaluate_model` provide standard model evaluation on 
out-of-sample data, while `evaluate_model_over_sliding_window` performs model retraining and 
evaluation over a sliding window.
"""
