...
"""
title: Information Processing for Time Series
description: A collection of tools for common transformations in multivariate time series contexts. A recurring theme 
             is aligning measurements with a forecast horizon to support machine learning training workflows.
"""
