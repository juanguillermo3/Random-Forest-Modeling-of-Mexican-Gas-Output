"""
Title: ML Samples
Description: A utility for generating training and test datasets tailored to forecasting applications.
This tool ensures proper alignment of target and feature data based on the forecast horizon before
splitting the dataset for standard machine learning tasks.
"""
